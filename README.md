...
This application allows users to track, rate, and discover anime series. Backend API is built with NestJS, MongoDB for data storage, and React for the frontend interface.
